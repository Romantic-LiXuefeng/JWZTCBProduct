...
public class FrameListViewEdit extends FrameLayout {
    ...
    private FrameSelectorViewEdit mCurSelectorView;
    ...
    public FrameListViewEdit(@NonNull Context context) {
        super(context);
    }

    public FrameListViewEdit(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        View view = LayoutInflater.from(context).inflate(R.layout.frame_list_viewedit, this);
    ...
    public FrameSelectorViewEdit addSelectorView() {
        mCurSelectorView = new FrameSelectorViewEdit(mContext);
    ...
    public View addSelectedRect(View view) {
        mCurSelectorView = (FrameSelectorViewEdit) view;
    ...
    public void showSelectorByRectView(FrameSelectorViewEdit selectorView, View rectView) {
    ...
    public void removeSelectorViewEdit(FrameSelectorViewEdit selectorView) {
        mScrollViewParent.removeView(selectorView);
    }
