...
//			pullUpView.setVisibility(View.VISIBLE);
		...
		case RELEASE_TO_REFRESH:
			...
			refreshStateTextView.setText(R.string.release_to_refresh);
			 AnimationDrawable animator = (AnimationDrawable) refreshingView.getBackground();  
		...
		case REFRESHING:
			// 正在刷新状态
			refreshingView.setVisibility(View.VISIBLE);
			 AnimationDrawable animators = (AnimationDrawable) refreshingView.getBackground();  
	            // imageView.setImageDrawable(null);  
	             animators.start();  
		...
		case RELEASE_TO_LOAD:
			...
			loadStateTextView.setText(R.string.release_to_load);
			 AnimationDrawable animatorss = (AnimationDrawable) loadingView.getBackground();  
	            // imageView.setImageDrawable(null);  
			 animatorss.start();
	        break;
		case LOADING:
...
//			pullUpView.setVisibility(View.INVISIBLE);
			 AnimationDrawable animatorssd = (AnimationDrawable) loadingView.getBackground();  
	            // imageView.setImageDrawable(null);  
			 animatorssd.start();
