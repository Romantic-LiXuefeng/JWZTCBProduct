...
import com.jwzt.caibian.adapter.WheelAdapter;
...
public class WheelView extends View {
	...
	private static  int VALUE_TEXT_COLOR = 0xff28b6e6; //0xF0000000;

	/** Items text color */
	private static int ITEMS_TEXT_COLOR = 0xFF9e9e9e; //0xFF000000;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0x10e6e6e6,
			0x08e6e6e6, 0x00e6e6e6 };

	/** Additional items height (is added to standard text item height) */
	private static final int ADDITIONAL_ITEM_HEIGHT = 24; //15
	 ...
	 */
	public void setAdapter(NumericWheelAdapter adapter) {
...
//		drawCenterRect(canvas);
	...
	public void setSelectItemTextColor(int color){
