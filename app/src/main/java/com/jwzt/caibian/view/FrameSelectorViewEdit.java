...
public class FrameSelectorViewEdit extends RelativeLayout {
    ...
    public FrameSelectorViewEdit(Context context) {
        this(context, null);
    }

    public FrameSelectorViewEdit(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.frame_selector_viewedit, this);
...
//        mHandlerBody.getBackground().setAlpha(80);
//        mHandlerBody.setBackground(getResources().getDrawable(R.drawable.frame_selector_body));
