...
import com.jwzt.caibian.activity.SelectTiDetailsActivity;
 ...
 * @author howie
 */
public class SelectTiAdapter extends BaseAdapter {
    /***移除条目的监听*/
    ...
    public SelectTiAdapter(Context mContext, List<TestGroupBean> newUploadinglistBean) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(mContext, R.layout.selectti_item_layout, null);
        ...
        holder.rl.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent=new Intent(mContext,SelectTiDetailsActivity.class);
