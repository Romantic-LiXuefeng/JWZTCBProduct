...
public class ShenheAdapter extends BaseAdapter {
    ...
    public ShenheAdapter(Context mContext, List<TestGroupBean> newUploadinglistBean,String type) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        try {
            if(position<mNewUploadinglistBean.size()){
                    ...
                    holder.rl.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View arg0) {
                            ...
                            intent.putExtra("createUserId", mNewUploadinglistBean.get(position).getCreateUserId());
            ...
            //                        mContext.startActivity(intent);
            //                    } else {
            //                        Intent intent = new Intent(mContext, PreviewGaojianActivity.class);
            //                        intent.putExtra("id", mNewUploadinglistBean.get(position).getId());
            //                        if (statu == 0) {
            //                            operateType = "1";
            //                        } else if (statu == 1) {
            ...
            //				}
                ...
                String author = mNewUploadinglistBean.get(position).getAuthor();
                ...
                String terminalType = mNewUploadinglistBean.get(position).getTerminalType();
                if("1".equals(terminalType)){
                    holder.tv_type.setText("新媒体");
                    holder.iv_type.setImageResource(R.drawable.gj_phone);
                }else if("2".equals(terminalType)){
                    holder.tv_type.setText("报纸");
                    holder.iv_type.setImageResource(R.drawable.gj_bz);
                }else if("3".equals(terminalType)){
                    holder.tv_type.setText("电视");
                    holder.iv_type.setImageResource(R.drawable.gj_tv);
                }
    ...
    public class ViewHolder {
        ...
        TextView tv_title;
        TextView tv_time;
        ImageView iv,iv_type;
        TextView tv_date;
        TextView tv_author,tv_type;
