...
public class CameraConfigDialog {
    ...
    private CheckBox cbRec, cbMV, cbPhoto, cbOsd, cbAntiChange, cbFrontMirror, cbRecordSupportPlayMusic,
            cbBeauty;
    private Switch swIsSaveToAlbum, swEnableAlbum, swUseCustomAlbum;
    private RadioGroup rgCameraMode, rgIsRearCamera, rgFaceU, rgOrientation;
    ...
    OnCheckedChangeListener CameraCheckListener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton buttonView,
            ...
            } else if (id == R.id.cbFrontMirror) {
                tempData.enableFrontMirror = isChecked;
            } else if (id == R.id.cbEnableBeauty) {
                tempData.enableBeauty = isChecked;
            } else if (id == R.id.cbRecordSupportPlayMusic) {
                tempData.enablePlayMusic = isChecked;
            }
    ...
    private void initCameraDialogView(View view) {
        cbRecordSupportPlayMusic = (CheckBox) view.findViewById(R.id.cbRecordSupportPlayMusic);
        ...
        cbFrontMirror = (CheckBox) view.findViewById(R.id.cbFrontMirror);
        cbBeauty = (CheckBox) view.findViewById(R.id.cbEnableBeauty);

        cbRecordSupportPlayMusic.setOnCheckedChangeListener(CameraCheckListener);
        cbBeauty.setOnCheckedChangeListener(CameraCheckListener);
        cbFrontMirror.setOnCheckedChangeListener(CameraCheckListener);
        ...
        cbRecordSupportPlayMusic.setChecked(tempData.enablePlayMusic);
        cbBeauty.setChecked(tempData.enableBeauty);
        cbFrontMirror.setChecked(tempData.enableFrontMirror);
        ...
        if (tempData.mRecordOrientation == CameraConfiguration.ORIENTATION_PORTRAIT) {
            rgOrientation.check(R.id.rbOrientationPortrait);
        } else if (tempData.mRecordOrientation == CameraConfiguration.ORIENTATION_LANDSCAPE) {
            rgOrientation.check(R.id.rbOrientationLandscape);
        } else if (tempData.mRecordOrientation == CameraConfiguration.ORIENTATION_AUTO) {
                ...
                .setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                        if (checkedId == R.id.rbOrientationPortrait) {
                            tempData.mRecordOrientation = CameraConfiguration.ORIENTATION_PORTRAIT;
                        } else if (checkedId == R.id.rbOrientationLandscape) {
                            tempData.mRecordOrientation = CameraConfiguration.ORIENTATION_LANDSCAPE;
                        } else if (checkedId == R.id.rbOrientationAuto) {
                            tempData.mRecordOrientation = CameraConfiguration.ORIENTATION_AUTO;
                        }
                    }
                });
