...
//    public static final String DOMAIN = "panm32w98.bkt.clouddn.com";
    ...
    public static final String VIDEO_STORAGE_DIR = Environment.getExternalStorageDirectory() + "/JWZTCBProduct/";
    public static final String VIDEO_STORAGE_TRIM = Environment.getExternalStorageDirectory() + "/JWZTCBPTrim/";
    public static  String RECORD_FILE_PATH;//录制视频时保存最终视频的路径
