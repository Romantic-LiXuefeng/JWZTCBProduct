...
import com.jwzt.caibian.activity.TextEditActivity;
 ...
 * 贴图合成任务 抽象类
 */
public abstract class StickerTask_2 extends AsyncTask<Bitmap, Void, Bitmap> {
    private Dialog dialog;

    private TextEditActivity mContext;

    public StickerTask_2(TextEditActivity activity) {
    ...
    protected Bitmap doInBackground(Bitmap... params) {
        ...
        BitmapUtils.saveBitmap(resultBit, mContext.filePath);
        BitmapUtils.saveBitmap(resultBit, mContext.new_filePath_sub);
        return resultBit;
    }
