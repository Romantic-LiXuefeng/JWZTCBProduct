...
public class TaskDetailsBean implements Serializable {
	...
	private List<TaskListResourceListBean> resourceList;//资源集合
	private String clueList;//意义不明确（暂时没用）
	private List<String> userIds;//意义不明确（暂时没用）
	private List<TaskListUserListBean> userList;//用户组
	private List<TaskListUsersBean> users;//参与人员
	public String getId() {
		return id;
	}
	...
	public List<TaskListResourceListBean> getResourceList() {
		return resourceList;
	}
	public void setResourceList(List<TaskListResourceListBean> resourceList) {
	...
	public List<TaskListUserListBean> getUserList() {
		return userList;
	}
	public void setUserList(List<TaskListUserListBean> userList) {
		this.userList = userList;
	}
	public List<TaskListUsersBean> getUsers() {
		return users;
	}
	public void setUsers(List<TaskListUsersBean> users) {
		this.users = users;
	}
