...
/**
 * FlowPopulateLayout will arrange child elements horizontally one next to another. If there is not enough
...
public class FlowPopulateLayout extends ViewGroup {
    ...
    public FlowPopulateLayout(Context context) {
        this(context, null);
    }

    public FlowPopulateLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowPopulateLayout(Context context, AttributeSet attrs, int defStyle) {
