...
public class WaveformView_2 extends View {
	...
	public WaveformView_2(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mSelectedLinePaint.setColor(
            getResources().getColor(R.color.waveform_unselected1));
		...
		bottomHalfPaint.setColor(getResources().getColor(R.color.hui));
    ...
    protected void onDraw(Canvas canvas) {
       ...
       // canvas.drawARGB(255, 42, 53, 82);
        ...
        if (mSoundFile == null){
            ...
            centerLine.setColor(Color.rgb(18, 166, 79));
            canvas.drawLine(0, height*0.5f+line_offset/2, measuredWidth, height*0.5f+line_offset/2, centerLine);//中心线  
            paintLine =new Paint();
            paintLine.setColor(Color.rgb(169, 169, 169));
            return;
