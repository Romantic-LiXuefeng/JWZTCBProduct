...
import com.jwzt.caibian.widget.MatrixImageView.OnMovingListener;
import com.jwzt.caibian.widget.MatrixImageView.OnSingleTapListener;
...
//			mImageLoader.loadImage(path, imageView, mOptions);
		...
		OnClickListener playVideoListener=new OnClickListener() {
			...
			public void onClick(View v) {
				...
				path=path.replace(getContext().getResources().getString(R.string.Thumbnail),getContext().getResources().getString(R.string.Video));
