...
import com.jwzt.caibian.interfaces.IDisposable;
import com.jwzt.caibian.util.Cubic;
import com.jwzt.caibian.util.Easing;
...
public abstract class ImageViewTouchBase extends ImageView implements
	...
	protected void _setImageDrawable(final Drawable drawable,
		...
		if (drawable != null) {
			...
			if (LOG_ENABLED) {
				System.out.println("==========="+"size: " + drawable.getIntrinsicWidth() + "x"
