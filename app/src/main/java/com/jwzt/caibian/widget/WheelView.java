...
import com.jwzt.caibian.adapter.WheelViewAdapter;
import com.jwzt.caibian.listener.OnWheelChangedListener;
import com.jwzt.caibian.listener.OnWheelChangedListener1;
import com.jwzt.caibian.listener.OnWheelClickedListener;
import com.jwzt.caibian.listener.OnWheelScrollListener;
import com.jwzt.caibian.listener.OnWheelScrollListener1;
import com.jwzt.caibian.view.ItemsRange;
import com.jwzt.caibian.view.WheelRecycle;
import com.jwzt.caibian.view.WheelScroller;
...
public class WheelView extends View {
    ...
    // Listeners
    private List<OnWheelChangedListener1> changingListeners = new LinkedList<OnWheelChangedListener1>();
    private List<OnWheelScrollListener1> scrollingListeners = new LinkedList<OnWheelScrollListener1>();
     ...
     *            the listener
     */
    public void addChangingListener(OnWheelChangedListener1 listener) {
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        for (OnWheelChangedListener1 listener : changingListeners) {
     ...
     *            the listener
     */
    public void addScrollingListener(OnWheelScrollListener1 listener) {
    ...
    protected void notifyScrollingListenersAboutStart() {
        for (OnWheelScrollListener1 listener : scrollingListeners) {
    ...
    private void drawShadows(Canvas canvas) {
        ...
        topShadow.setBounds(0, 0, getWidth(), height*3);
