...
import com.jwzt.caibian.adapter.TimeAdapter;
import com.jwzt.caibian.interfaces.ScrollViewListener;
import com.jwzt.caibian.util.AudioUtils;
import com.jwzt.caibian.util.CheapWAV;
import com.jwzt.caibian.util.DateUtils;
import com.jwzt.caibian.util.DensityUtil;
import com.jwzt.caibian.util.IsNonEmptyUtils;
import com.jwzt.caibian.util.SamplePlayer;
...
import com.jwzt.caibian.widget.ProgressView_audio;
import com.jwzt.caibian.widget.WaveCanvas;
import com.jwzt.caibian.widget.WaveSurfaceView;
import com.jwzt.caibian.widget.WaveformView;
...
//	private ProgressView_audio ssprogressView;
	...
	protected void onCreate(Bundle savedInstanceState) {
       ...
       // popupWindows = new PopupWindows(AudioActivity.this, bottomLayout);
        initView();
	        U.createDirectory();
	        if(waveSfv != null) {
...
private View parent;
            ...
            private final TextView tv_current_position;
            ...
            public PopupWindows(Context mContext, View parent){
                ...
                tv_current_position = view.findViewById(R.id.tv_current_position);
                tv_current_position.setText(application.getLocation()+"");
                tv_current_position.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
//                        Intent intent=new Intent(AudioActivity.this,LocationActivity.class);
				...
				reName.addTextChangedListener(new TextWatcher() {
					...
					public void onTextChanged(CharSequence s, int start, int before,int count) {
						...
						if(IsNonEmptyUtils.isString(content)){
						    ...
						    if( m.find()){
						    	reName.setText(content.substring(0, content.length()-1));
						    	reName.setSelection(content.length()-1);
						        Toast.makeText(AudioActivity.this, "不允许输入特殊符号！", Toast.LENGTH_LONG).show();
						    }else{
...
//	         	             temp_fs[1] = (long) (fs[1]*numFrames/(totalTime/1000));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==CODE_LOCATION){//定位
            if(data!=null){
