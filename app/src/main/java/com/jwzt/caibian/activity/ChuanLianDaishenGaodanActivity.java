 ...
 * @author howie
 */
public class ChuanLianDaishenGaodanActivity extends BaseActivity implements OnClickListener {
    /**
     * 标题
     */
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 3:
                    dismisLoadingDialog();
                    Toast.makeText(ChuanLianDaishenGaodanActivity.this, "排序保存成功", 1).show();
                    break;
                case 6:
                    dismisLoadingDialog();
                    Toast.makeText(ChuanLianDaishenGaodanActivity.this, "排序保存失败", 1).show();
                    break;
                case 5:
                    dismisLoadingDialog();
                    Toast.makeText(ChuanLianDaishenGaodanActivity.this, "审核通过", 1).show();
                    break;
                case 7:
...
//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showLoadingDialog(ChuanLianDaishenGaodanActivity.this, "", "");
        DynamicRequestPermissionUtils.requestPermissionRECORDAUDIO(ChuanLianDaishenGaodanActivity.this, new String[]{Manifest.permission.RECORD_AUDIO}, 2);
        findViews();
        initData();
    }
    ...
    private void initData() {
        ...
        if (mLoginBean != null) {
          ...
          //  }else{
                liveListUrl = String.format(Configs.getChuanliandangao, id);
          //  }
...
//            } else {
    ...
    private void initView() {
        liveListAdapter = new MessageAdapter(ChuanLianDaishenGaodanActivity.this, mList);
...
String liveListUrl = String.format(Configs.getChuandiandanMessage, id);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			  /* Intent  intent=new Intent(ChuanLianGaodanActivity.this,ShowNewsDeatilsActivity.class);
			   ...
			   intent.putExtra("contents", mList.get(position).getContent());
                ...
                Intent intent = new Intent(ChuanLianDaishenGaodanActivity.this, PreviewWanCHengActivity.class);
                ...
                ChuanLianDaishenGaodanActivity.this.startActivity(intent);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_plus://加号按钮
                Intent intent_create = new Intent(ChuanLianDaishenGaodanActivity.this, CreateLiveActivity.class);
...
//                    Intent intent = new Intent(ChuanLianDaishenGaodanActivity.this, CLDShenheUploadedActivity.class);
//                    intent.putExtra("id", mList.get(position).getId());
//                    String status = mList.get(position).getStatus();
//                    intent.putExtra("operateType", mList.get(position).getStatus());
//                    ChuanLianDaishenGaodanActivity.this.startActivity(intent);
