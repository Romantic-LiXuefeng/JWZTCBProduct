 ...
 *
 */
public class PreviewGaojianActivity extends BaseActivity implements OnClickListener {
	/**标题*/
	private TextView tv_titles,titleName,tv_time,tv_author_name,tv_type,tv_location,tv_image_num,tv_video_num,tv_audio_num,tv_all;
	...
	private Handler mHandler=new Handler(){
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				break;
			case 11:
				Toast.makeText(PreviewGaojianActivity.this, "审核通过成功", 1).show();
				dismisLoadingDialog();
				PreviewGaojianActivity.this.finish();
				break;
			case 12:
                Toast.makeText(PreviewGaojianActivity.this, "审核驳回成功", 1).show();
				dismisLoadingDialog();
				PreviewGaojianActivity.this.finish();
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		application=(CbApplication) PreviewGaojianActivity.this.getApplication();
...
//        .displayer(new FadeInBitmapDisplayer(100))
	...
	private void initData(){
		if (CbApplication.getNetType() != -1) {
			showLoadingDialog(PreviewGaojianActivity.this, "", "");
	...
	private void findViews() {
		...
		LinearLayout	xiugaibaocun=(LinearLayout) findViewById(R.id.xiugaibaocun);
		xiugaibaocun.setVisibility(View.GONE);
...
//		wb_content.loadDataWithBaseURL(null, url, "text/html", "UTF-8", null);
	...
	private void addViews(){
		...
		for (int i = 0; i < mList.size(); i++) {
			View view=View.inflate(PreviewGaojianActivity.this, R.layout.media_item_layout, null);
...
//					startActivity(intent);
					...
					if(fileRealPath.endsWith("mp4")||fileRealPath.endsWith("mp3")){
						Intent videointent=new Intent(PreviewGaojianActivity.this, ShowVideoActivity.class);
						videointent.putExtra("playpath", fileRealPath);
						startActivity(videointent);
					}else{
						Intent intent=new Intent(PreviewGaojianActivity.this, ShowImageActivity.class);
...
//						}
	...
	public void onClick(View v) {
		...
		case R.id.tv_edit://编辑按钮
			Intent intent=new Intent(PreviewGaojianActivity.this,NewScriptActivity.class);
		...
		case R.id.tv_all:
			if(mNewUploadinglistBean!=null){
				...
				if(IsNonEmptyUtils.isList(list)){
					Intent intent_all=new Intent(PreviewGaojianActivity.this,AllFootageActivity.class);
					intent_all.putExtra("alls",  (Serializable)list);
					startActivity(intent_all);
					overridePendingTransition(R.anim.push_left_in,R.anim.push_left_out);
				}else{
					UserToast.toSetToast(PreviewGaojianActivity.this, "没有全部内容");
				}
			}
	...
	private void showTip(){
		if(IsNonEmptyUtils.isString(mNewUploadinglistBean.getStatus())){
			...
			if(status==2){//表示退稿
				...
				alertDialog.show();
				View view = View.inflate(PreviewGaojianActivity.this,R.layout.check_message_layout, null);
	 ...
	 /**
	    ...
	    */
		private void showWindow() {
			...
			View view = LinearLayout.inflate(PreviewGaojianActivity.this,
			...
			imageButton_queding.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if ("".equals(tv_contents.getText().toString())) {
						Toast.makeText(PreviewGaojianActivity.this, "请填写驳回理由", 1).show();
						return;
					}
					CommitData();
					tv_contents.setText("");
		...
		private void shenheData(){
			...
			showLoadingDialog(PreviewGaojianActivity.this, "", "");
			//详情内容获取
			String detailsUrl = String.format(Configs.gaojiantijiao,  id,userid);
			@SuppressWarnings("unused")
			String cacheKey_xiao_hengtu= detailsUrl + "get";
