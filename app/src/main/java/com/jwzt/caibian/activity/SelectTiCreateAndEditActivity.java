 ...
 * @author howie
 */
public class SelectTiCreateAndEditActivity extends BaseActivity implements OnClickListener {
    private TextView tv_titles, titleName, tv_edit;
    private RelativeLayout rl_type, rl_pro;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selectti_createandedit_activity);
        application = (CbApplication) SelectTiCreateAndEditActivity.this.getApplication();
    ...
    private void initData() {
        if (CbApplication.getNetType() != -1) {
            showLoadingDialog(SelectTiCreateAndEditActivity.this, "", "");
        ...
        gv_resource.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (fileRealPath.endsWith("mp4") || fileRealPath.endsWith("mp3")) {
                    Intent videointent = new Intent(SelectTiCreateAndEditActivity.this, ShowVideoActivity.class);
                    videointent.putExtra("playpath", fileRealPath);
                    startActivity(videointent);
                } else {
                    Intent intent = new Intent(SelectTiCreateAndEditActivity.this, ShowImageActivity.class);
    ...
    private void initView() {
        ...
        if (IsNonEmptyUtils.isList(resourceList)) {
            gv_resource.setAdapter(new ResourceGVAdapter(SelectTiCreateAndEditActivity.this, resourceList));
        }
            ...
            case R.id.tv_all:
                if (mNewUploadinglistBean != null) {
                    ...
                    if (IsNonEmptyUtils.isList(list)) {
                        Intent intent_all = new Intent(SelectTiCreateAndEditActivity.this, AllFootageActivity.class);
                        intent_all.putExtra("alls", (Serializable) list);
                        startActivity(intent_all);
                        overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
                    } else {
                        UserToast.toSetToast(SelectTiCreateAndEditActivity.this, "没有全部内容");
                    }
                }
                break;
        }
