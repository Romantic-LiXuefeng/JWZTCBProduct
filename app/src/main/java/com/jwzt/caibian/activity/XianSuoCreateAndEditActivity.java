 ...
 * @author howie
 */
public class XianSuoCreateAndEditActivity extends BaseActivity implements OnClickListener {
    private TextView tv_titles, tv_location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xiansuo_createandedit);
        application = (CbApplication) XianSuoCreateAndEditActivity.this.getApplication();
    ...
    private void initData() {
        if (CbApplication.getNetType() != -1) {
            showLoadingDialog(XianSuoCreateAndEditActivity.this, "", "");
        ...
        gv_resource.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (fileRealPath.endsWith("mp4") || fileRealPath.endsWith("mp3")) {
                    Intent videointent = new Intent(XianSuoCreateAndEditActivity.this, ShowVideoActivity.class);
                    videointent.putExtra("playpath", fileRealPath);
                    startActivity(videointent);
                } else {
                    Intent intent = new Intent(XianSuoCreateAndEditActivity.this, ShowImageActivity.class);
    ...
    private void initView() {
        ...
        if (IsNonEmptyUtils.isList(resourceList)) {
            gv_resource.setAdapter(new ResourceGVAdapter(XianSuoCreateAndEditActivity.this, resourceList));
        }
            ...
            case R.id.tv_all:
                if (mNewUploadinglistBean != null) {
                    ...
                    if (IsNonEmptyUtils.isList(list)) {
                        Intent intent_all = new Intent(XianSuoCreateAndEditActivity.this, AllFootageActivity.class);
                        intent_all.putExtra("alls", (Serializable) list);
                        startActivity(intent_all);
                        overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
                    } else {
                        UserToast.toSetToast(XianSuoCreateAndEditActivity.this, "没有全部内容");
                    }
                }
                break;
        }
