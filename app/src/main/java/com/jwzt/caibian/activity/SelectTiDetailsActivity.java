 ...
 * @author howie
 */
public class SelectTiDetailsActivity extends BaseActivity implements OnClickListener {
    private TextView tv_titles, titleName, tv_edit, tv_save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selectti_details_activity);
        application = (CbApplication) SelectTiDetailsActivity.this.getApplication();
    ...
    private void initData() {
        if (CbApplication.getNetType() != -1) {
            showLoadingDialog(SelectTiDetailsActivity.this, "", "");
        ...
        gv_resource.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (fileRealPath.endsWith("mp4") || fileRealPath.endsWith("mp3")) {
                    Intent videointent = new Intent(SelectTiDetailsActivity.this, ShowVideoActivity.class);
                    videointent.putExtra("playpath", fileRealPath);
                    startActivity(videointent);
                } else {
                    Intent intent = new Intent(SelectTiDetailsActivity.this, ShowImageActivity.class);
    ...
    private void initView() {
        ...
        if (IsNonEmptyUtils.isList(resourceList)) {
            gv_resource.setAdapter(new ResourceGVAdapter(SelectTiDetailsActivity.this, resourceList));
        }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_edit:// 编辑按钮
                Intent intent = new Intent(SelectTiDetailsActivity.this, SelectTiCreateAndEditActivity.class);
            ...
            case R.id.tv_all:
                if (mNewUploadinglistBean != null) {
                    ...
                    if (IsNonEmptyUtils.isList(list)) {
                        Intent intent_all = new Intent(SelectTiDetailsActivity.this, AllFootageActivity.class);
                        intent_all.putExtra("alls", (Serializable) list);
                        startActivity(intent_all);
                        overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
                    } else {
                        UserToast.toSetToast(SelectTiDetailsActivity.this, "没有全部内容");
                    }
                }
                break;
        }
