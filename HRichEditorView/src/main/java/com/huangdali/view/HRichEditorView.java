...
public class HRichEditorView extends Activity {
    ...
    private void initView() {
        ...
        rl_item = findViewById(R.id.ll_additem_addarea);
        iv_additem_add = findViewById(R.id.iv_additem_add);

        iv_additem_add.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        rvItemList.setHasFixedSize(true);//最重要的这句，不然recycleview不显示
        ...
        findViewById(R.id.iv_additem_img).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hideAddArea();
                EContent eContent = new EContent();
        ...
        findViewById(R.id.iv_additem_txt).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hideAddArea();
                EContent eContent = new EContent();
        ...
        findViewById(R.id.iv_additem_video).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EContent eContent = new EContent();
                eContent.setType(ItemType.VIDEO);
    ...
    private void showAddItemArea() {
        iv_additem_add.setVisibility(View.GONE);
    ...
    private void hideAddArea() {
        ...
        iv_additem_add.setVisibility(View.VISIBLE);
    }
