...
//        sGlideRequests = GlideApp.with(mContext);
    ...
    public Drawable getDrawable(String source) {
        System.out.println("URIsource======================="+source);
...
//            Glide.with(mContext).load(source).asBitmap().transform(new CenterCrop(mContext),new GlideRoundImage(mContext));
            Glide.with(mContext).load(source).asBitmap().centerCrop().into(bitmapTarget);
            ...
            try {
                ...
                Glide.with(mContext).load(uri).asBitmap().centerCrop().into(bitmapTarget);
//              /  Glide.with(mContext).load(uri).asBitmap().transform(new CenterCrop(mContext),new GlideRoundImage(mContext));
                return areUrlDrawable;
