...
public class ARE_FontColor extends ARE_ABS_Dynamic_Style<AreForegroundColorSpan> {
	...
	public ARE_FontColor(ImageView fontColorImage) {
		...
		setListenerForImageView(this.mFontColorImageView,0,0);
	}
	...
	@Override
	public void setListenerForImageView(final ImageView imageView, int Size, final int lastSpanColor) {
		imageView.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				System.out.println("color======"+lastSpanColor);
