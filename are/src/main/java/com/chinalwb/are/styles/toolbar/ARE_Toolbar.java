...
import com.chinalwb.are.styles.ARE_Yunyin;
...
public class ARE_Toolbar extends LinearLayout {
	 ...
	 */
	public  ArrayList<IARE_Style> mStylesList = new ArrayList<IARE_Style>();
	...
	private ARE_Yunyin mYuyinStyle;
	 ...
	 * 语音
	 * */
	private ImageView mYuyinImageView;
	...
	private void initViews() {
		...
		this.mYuyinImageView = this.findViewById(R.id.rteYuyin);
	...
	private void initStyles() {
		...
		this.mYuyinStyle = new ARE_Yunyin(this.mYuyinImageView);
		...
		this.mStylesList.add(this.mYuyinStyle);
	...
	private void bindToolbar() {
		...
		this.mYuyinStyle.setEditText(this.mEditText);
