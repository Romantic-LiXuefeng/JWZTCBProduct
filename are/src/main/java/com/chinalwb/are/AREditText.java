...
//		});
	...
	//	System.out.println("===============selStart============"+selStart+"=======selEnd==="+selEnd);
		if(null!=mOnSelectionChanged){
			mOnSelectionChanged.OnselectionChanged(selStart,selEnd);
		}
	    if (mToolbar == null) {
	        return;
        }
...
//		ARE_Helper.updateCheckStatus(sToolbar.getQuoteStyle(), quoteExists);
	...
	public OnSelectionChanged mOnSelectionChanged;
	public void setOnSelectionChanged(OnSelectionChanged mOnSelectionChanged){
		this.mOnSelectionChanged=mOnSelectionChanged;
	}
